...
export const FacebookModal = ({active, onClose}) => {
    ...
    return (
        <FrameModal onClose={onClose} active={active} title="Facebook">
            <div className="frame-modal-icon">
                <FontAwesomeIcon icon={faFacebookSquare}/>
            </div>
            <input type="text" className="form-control" placeholder="Paste a facebook video link"
